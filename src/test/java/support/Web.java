...
public class Web {
    ...
    public static String driverPathWindows = "src/test/java/resources/drivers/chromedriver.exe".replace("/", File.separator);
    public static String driverPathLinux = "src/test/java/resources/drivers/chromedriver".replace("/", File.separator);
